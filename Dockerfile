...
RUN apt-get update && apt-get install -y lsb-release curl sudo nano git zip unzip libzip-dev zip gnupg dirmngr && apt-get clean
...
RUN apt-get update && apt-get install -y gum && apt-get clean
